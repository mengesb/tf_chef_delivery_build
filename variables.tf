...
variable "basename" {
  description = "Basename for AWS Name tag of CHEF Delivery build servers. Default: delivery-build"
  default = "delivery-build"
}
variable "chef_fqdn" {
...
variable "server_count" {
  description = "Number of Delivery build servers to provision. Default: 5"
  default = 5
}
variable "tag_description" {
  description = "Delivery server AWS description tag text"
  default     = "Created using Terraform (tf_chef_delivery_build)"
}
